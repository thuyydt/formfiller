 ...
 * ### Overview
 *
 * To quickly generate a date in the past, use [`recent()`] (last day) or [`past()`] (last year).
 * To quickly generate a date in the future, use [`soon()`] (next day) or [`future()`] (next year).
 * For a realistic birthdate for an adult, use [`birthdate()`].
 *
