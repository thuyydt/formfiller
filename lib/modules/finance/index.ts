...
export class FinanceModule extends ModuleBase {
  ...
  creditCardNumber(
    ...
    if (normalizedIssuer in localeFormat) {
      const issuerFormats = localeFormat[normalizedIssuer];
      format = this.faker.helpers.arrayElement(issuerFormats ?? []);
      ...
      format = this.faker.helpers.arrayElement(formats as readonly string[]);
    }
